Object.assign(translations.en, {
    "rec_sights_title": "Sights",
    "sights_intro_text": "Valladolid has plenty to see. Here are the highlights you shouldn't miss.",
    "rec_cathedral_title": "The Cathedral",
    ...
    "rec_park_title": "Campo Grande",
    "recommendations_park_text": "Our central park is called Campo Grande – a charming Castilian irony, as it's not that big. It's a pretty little park, with ducks, geese, and pigeons, and perfect for a short walk.<br><br>It's especially famous for its peacocks roaming freely.<br><br>👉 {{LINK_CAMPO_GRANDE_MAPS}}",
...
Object.assign(translations.es, {
    ...
    "sights_intro_text": "Valladolid tiene mucho que ver. Estos son los puntos clave que no te puedes perder.",
    "rec_cathedral_title": "La Catedral",
    "recommendations_cathedral_text": "Nuestra gran catedral fue diseñada por el mismo arquitecto que construyó el complejo del palacio y monasterio de <em>El Escorial</em>, cerca de Madrid, así que los planos eran, digamos, ambiciosos. Diseñó lo que habría sido un edificio colosal, pero entonces... a España se le acabó el dinero. Un clásico. Lo que queda hoy es menos de la mitad del plano original, un impresionante monumento a la idea de que no pasa nada por no terminar todo lo que empiezas.",
    "rec_park_title": "Campo Grande",
    "recommendations_park_text": "Nuestro parque central se llama Campo Grande, una simpática ironía castellana, ya que no es muy grande. Es un parque pequeño y bonito, con patos, gansos y palomas, y perfecto para un pequeño paseo.<br><br>Es famoso por sus pavos reales.<br><br>👉 {{LINK_CAMPO_GRANDE_MAPS}}",
...
Object.assign(translations.de, {
    ...
    "sights_intro_text": "Valladolid hat viel zu bieten. Hier sind die Highlights, die ihr nicht verpassen solltet.",
    "rec_cathedral_title": "Die Kathedrale",
    "recommendations_cathedral_text": "Entworfen vom Architekten des El Escorial, sollte sie die größte Kathedrale Europas werden... bis das Geld ausging. Sie ist nur zu 45% fertig, aber trotzdem beeindruckend.",
    "rec_park_title": "Campo Grande",
    "recommendations_park_text": "Unser zentraler Park heißt Campo Grande – eine charmante kastilische Ironie, denn so groß ist er gar nicht. Er ist ein hübscher kleiner Park, mit Enten, Gänsen und Tauben und perfekt für einen kleinen Spaziergang.<br><br>Es ist besonders bekannt für seine freilaufenden Pfauen, denen der Park quasi gehört.<br><br>👉 {{LINK_CAMPO_GRANDE_MAPS}}",
